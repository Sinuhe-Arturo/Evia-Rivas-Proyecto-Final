    ...
    <div class="container">
        ...
        <form action="update.php" method="POST" class="form_ajax_update">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="product_name" id="" value="<?php echo $data['nombre'] ?>" reuired>
            </div>
            <div class="form-group">
                <label for="product_price">Precio del producto</label>
                <input type="text" class="form-control" name="product_price" id="" value="<?php echo $data['precio'] ?>" required>
            </div>
            <div class="form-group">
                <label for="product_img">Foto del producto</label>
                <input type="text" class="form-control" name="product_img" id="" value="<?php echo $data['foto'] ?>" required>
            </div>
