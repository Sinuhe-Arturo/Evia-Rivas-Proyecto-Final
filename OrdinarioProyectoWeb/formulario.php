...
<body>
    ...
    <div class="container">
        ...
        <br><br>
        <form action="guardar.php" method="POST" class="form_ajax" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="product_description" id="" required autocomplete= off>
            </div>
            <div class="form-group">
                <label for="product_img">Foto del producto</label>
                <input type="file" accept="image/*" class="form-control" name="product_img" id="imagen" required autocomplete= off>
            </div>
      ...
      <thead>
        ...
        ?>
            <tr id="fila-<?php echo $row['id'] ?>">
                ...
                <td><img src="imagenes-productos/<?php echo $row["foto"]?>" height="100px" width="100px"></td>
                <td>
